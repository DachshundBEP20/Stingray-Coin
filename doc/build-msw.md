...
See readme-qt.rst for instructions on building Stingray QT, the
...
One of Stingray’s dependencies that will not need to be compiled cause static lib package available (currently 1.0.2n) :
...
Build Stingray QT
-------
First we need to adapt c:\Stingray\Stingray-qt.pro file to fit dependencies compiled above. Modify this section at the beginning of the file accordingly :
...
Build leveldb, in MSYS shell executed from Mingw32.exe:
    ...
    cd /c/Stingray/src/leveldb
    make clean
    TARGET_OS=NATIVE_WINDOWS make libleveldb.a libmemenv.a

Still in MSYS2 shell, build Secp256k1

    cd /c/Stingray/src/secp256k1
    ./autogen.sh
    ./configure
    make

then it's finally possible to compile Stingray from Mingw32 Msys shell :
...
- following path will be used before compiling Stingray QT :
