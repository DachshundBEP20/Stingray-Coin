...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Stingray " + FormatFullVersion();
...
static const char *strDNSSeed[][2] = {
    {"seed1.Stingray-wallet.com", "seed1.Stingray-wallet.com"},
	{"seed2.Stingray-wallet.com", "seed2.Stingray-wallet.com"},
	{"seed3.Stingray-wallet.com", "seed3.Stingray-wallet.com"},
	{"seed4.Stingray-wallet.com", "seed4.Stingray-wallet.com"},
	{"seed5.Stingray-wallet.com", "seed5.Stingray-wallet.com"},
 };
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Stingray is probably already running."), addrBind.ToString());
        else
