...
const string strMessageMagic = "Stingray Signed Message:\n";
                        ...
                        bool* pfMissingInputs)
{
    ...
    // Rather not work on nonstandard transactions (unless -testnet)
    //alot of Stingray transactions seem non standard, its a bug so we have to accept these, the transactions have still been checekd to be valid and unspent.
    string reason;
...
#ifdef ENABLE_WALLET
// Stingray: attempt to generate suitable proof-of-stake
